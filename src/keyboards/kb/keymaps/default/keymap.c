...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KEYMAP(
		...
		KC_LCTL, KC_LGUI, KC_LALT, KC_NUBS, TO(0), KC_SPC, TO(1), KC_LEFT, KC_RGHT, KC_UP, KC_DOWN),
	...
	KEYMAP(
		...
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, TO(0), KC_TRNS, TO(1), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
